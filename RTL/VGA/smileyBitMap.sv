...
endmodule                    input  logic clk,
                    input  logic resetN,
                    input  logic [10:0] offsetX,
                    input  logic [10:0] offsetY,
                    input  logic InsideRectangle, 
                    input  logic [1:0] direction, 
                    input  logic bite_animation_trigger,
...
logic   [7:0] normal_color;
logic   [7:0] bite_color;
logic   [7:0] current_color;
localparam logic [7:0] TRANSPARENT_ENCODING = 8'hFF ;

assign current_color = bite_animation_trigger ? bite_color : normal_color;
