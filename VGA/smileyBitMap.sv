...
always_comb begin
    case(direction)
        2'b00: begin 
            mapped_X = 11'd15 - offsetY;
            mapped_Y = offsetX;
        end
        2'b01: begin 
            mapped_X = offsetY;
            mapped_Y = 11'd15 - offsetX;
        end
        2'b10: begin
            mapped_X = offsetX;
            mapped_Y = offsetY;
...
assign HitCodeX = mapped_X >> ( OBJECT_NUMBER_OF_X_BITS - 4 );  
assign HitCodeY = mapped_Y >> ( OBJECT_NUMBER_OF_Y_BITS - 4 );      
